...
(function (S) {
  ...
  S.bindLinesUI = function () {
    ...
    document.addEventListener("change", function (e) {
      ...
      else if (field === "function") line.function = t.value === "DFO" || t.value === "PAX" || t.value === "BAG" ? t.value : "";
      else if (field === "emp") { if (S.applyLineEmp) S.applyLineEmp(line, t.value); }
      else if (field === "shift") { if (S.applyLineShift) S.applyLineShift(line, t.value); }
      else if (field === "team") { if (S.setLineTeam) S.setLineTeam(lineId, t.value); }
