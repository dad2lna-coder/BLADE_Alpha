...
(function (S) {
  ...
  S.computeHourlyByDow = function () {
    ...
    function funcOk(line, dayOff) {
      ...
      if (fv === "dfo") {
        var tagged = S.lineIsDfoTagged ? S.lineIsDfoTagged(line) : (line.function === "DFO" || !!(line.functionEligible && line.functionEligible.dfo));
        return tagged && duty !== "BAG";
      }
      return true;
    }
