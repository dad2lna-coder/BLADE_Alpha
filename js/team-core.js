Great. Here is the consolidated content for the new team-core.js file.
...
(function (S) {
  ...
  /** Resizable & Draggable Floating Panel Fixes */
  ...
  S.initFloatPanels = function () {
    ...
    panels.forEach(function (panel, idx) {
      ...
      // Clear any forced inline widths/heights so CSS sizing takes control
      ...
      handle.addEventListener("mousedown", function (e) {
        ...
        // Get starting layout measurements
        ...
        // Keep current width and height on drag start so size doesn't reset
