 ...
 * Required headers (case-insensitive): DAY_OF_WEEK, ETD, CAPACITY, PERCENT_ORIGINATING.
 */

export const REQUIRED_HEADERS = ["DAY_OF_WEEK", "ETD", "CAPACITY", "PERCENT_ORIGINATING"];
...
export function parseFlightRow(values, map, multiplier) {
  ...
  if (dow == null || etdMin == null || seats == null || pctOrig == null) return null;
